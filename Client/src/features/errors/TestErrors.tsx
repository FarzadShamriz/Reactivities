    ...
    return (
        <>
            ...
            <ButtonGroup variant="contained" sx={{ mt: 4 }}>
                <Button onClick={() => handleError('not-found')}>
                    Not found
                </Button>
                <Button onClick={() => handleError('bad-request')}>
                    Bad request
                </Button>
                <Button onClick={() => handleError('activities', 'post')}>
                    Validation error
                </Button>
                <Button onClick={() => handleError('server-error')}>
                    Server error
                </Button>
                <Button onClick={() => handleError('unauthorised')}>
                    Unauthorised
                </Button>
            </ButtonGroup>
